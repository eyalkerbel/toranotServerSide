           ...
           // if (ValidOrNot.error === null) {
                MongoClient.connect(
                    ...
                    function (err, db) {
                        ...
                        var userid = req.body.userDeteails.userid;
                       ...
                       const promise1 = deleteToranotNotifactions(dbo,_id,obi._id);
                        ...
                        const promise3 = new Promise(resolve =>  dbo.collection("users").findOneAndUpdate({userid:req.body.userid}, { $inc: {'points': -1 } }, {new: true }).then(() => resolve(true)));
